package com.cuiwjava.charpter06.ExecutorCompletionService_0.test;

import com.cuiwjava.charpter06.ExecutorCompletionService_0.mycallable.MyCallable;
...
public class Test1 {
	...
	public static void main(String[] args) {
		try {
			...
			// 按照乱序打印的效果
			// 说明一个Future 对应当前先执行完的Callable任务
